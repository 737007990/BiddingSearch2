...
- (UILabel *)lastUpdateTimeLabel
{
    if (!_lastUpdateTimeLabel) {
        ...
        _lastUpdateTimeLabel.backgroundColor = [UIColor redColor];
        // 1.创建控件
...
-(void)setIsTimeLabHidden:(BOOL)isTimeLabHidden
{
    _isTimeLabHidden = isTimeLabHidden;
//    if (isTimeLabHidden==YES)
//    {
//        _lastUpdateTimeLabel.hidden = YES;
//        _lastUpdateTimeLabel.backgroundColor = [UIColor redColor];
//    }
