...
/**
 *  MHRefresh UIScrollView扩展
 */

#import <UIKit/UIKit.h>
@class MHRefreshHeaderView;
@class MHRefreshFooterView;
...
@property (copy, nonatomic) NSString *footerRefreshingText;         // 默认:@"MH哥正在帮你加载数据..."
...
@property (copy, nonatomic) NSString *headerRefreshingText;         // 默认:@"MH哥正在帮你刷新..."
