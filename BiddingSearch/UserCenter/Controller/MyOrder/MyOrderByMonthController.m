...
@interface MyOrderByMonthController ()<ASBaseModelDelegate>
...
@implementation MyOrderByMonthController
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [self.currentNavigationController setTitleText:@"包月推送" viewController:self];
    self.orderByMonthTypeListOperation.type = @"1";
...
- (void)confirmBtnClicked{
    WeakSelf(self);
    UIAlertController *vc = [UIAlertController alertControllerWithTitle:@"包月套餐" message:[NSString stringWithFormat:@"购买套餐：%@¥%@元",self.orderMonthType,self.price] preferredStyle:UIAlertControllerStyleAlert];
