...
@implementation MyOrderDetailOperation
- (void)requestStart{
    [super requestStart];
    self.porthName = [ASLOCATOR_MODEL getURLConfigInfoWithMethod:@"27"];
    self.params = [NSMutableDictionary dictionary];
    [self.params setNoNilObject:self.orderId forKey:@"id"];
