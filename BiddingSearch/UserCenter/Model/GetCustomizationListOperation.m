//
//  GetCustomizationListOperation.m
//  BiddingSearch
//
...
@interface GetCustomizationListOperation()
@property (nonatomic, strong) NSMutableDictionary *page;
@property (nonatomic, strong) NSMutableArray *resultArray;

@end

@implementation GetCustomizationListOperation
- (void)requestStart{
    [super requestStart];
    self.porthName = [ASLOCATOR_MODEL getURLConfigInfoWithMethod:@"10"];
...
- (void)configResultWithData:(NSDictionary *)dic{
    ...
    self.resultArray = [dic objectForKey:@"solution_list"];
