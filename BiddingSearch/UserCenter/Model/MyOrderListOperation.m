...
@interface MyOrderListOperation()
@property (nonatomic, strong) NSMutableDictionary *page;
@property (nonatomic, strong) NSMutableArray *resultArray;
@property (nonatomic, strong) NSMutableDictionary *params;
@end

@implementation MyOrderListOperation
- (void)requestStart{
    [super requestStart];
    self.porthName = [ASLOCATOR_MODEL getURLConfigInfoWithMethod:@"21"];
    ...
    [self.params setNoNilObject:self.invoice_state forKey:@"invoice_state"];
...
- (void)configResultWithData:(NSDictionary *)dic{
    ...
    self.resultArray = [dic objectForKey:@"recharge_list"];
