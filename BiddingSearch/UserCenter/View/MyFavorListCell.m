...
@implementation MyFavorListCell
...
- (void)configCellWIthData:(id)data{
    if ([data isKindOfClass:[NSDictionary class]]) {
        ...
        [_titleL setText:[dic nullToBlankStringObjectForKey:@"pname"]];
        NSAttributedString *attrStr = [[NSAttributedString alloc] initWithData:[[dic nullToBlankStringObjectForKey:@"tname"] dataUsingEncoding:NSUnicodeStringEncoding] options:@{ NSDocumentTypeDocumentAttribute: NSHTMLTextDocumentType } documentAttributes:nil error:nil];
        [_contentL setAttributedText:attrStr];
        [_industryL setText:[dic nullToBlankStringObjectForKey:@"work"]];
        [_areaL setText:[dic nullToBlankStringObjectForKey:@"area"]];
        [_timeL setText:[dic nullToBlankStringObjectForKey:@"date"]];
