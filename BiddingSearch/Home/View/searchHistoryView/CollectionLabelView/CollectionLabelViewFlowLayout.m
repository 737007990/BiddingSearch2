//
//  CollectionLabelViewFlowLayout.m
//  BiddingSearch
//
...
@implementation CollectionLabelViewFlowLayout {
...
- (void)prepareLayout {
    ...
    CollectionLabelFlowConfig *config = [CollectionLabelFlowConfig shareConfig];
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForSupplementaryViewOfKind:(NSString *)elementKind atIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([elementKind isEqualToString:@"UICollectionElementKindSectionHeader"]) {
        ...
        attri.frame = CGRectMake(0, orgin.totalY, self.collectionView.width, 80);
    }
